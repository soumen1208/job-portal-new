            ...
            <div className='max-w-xl mx-auto my-10'>
                <form onSubmit={submitHandler}>
                    <div className='flex items-center justify-between'>
                        ...
                        <h1 className='font-bold text-lg text-[#008080]'>Company Setup</h1>
                    </div>
                    ...
                    {
                        loading ? <Button className='w-full my-4 bg-[#008080]'> <Loader2 className='mr-2 h-4 w-4 animate-spin' /> Please wait... </Button> : <Button className='w-full my-4 bg-[#008080]' type='submit'>Update</Button>
                    }
                </form>
            </div>
        </div >
